                  ...
                  <ul className="p-6 space-y-6">
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://i.pravatar.cc/150?img=1" alt="Annette Watson profile picture"/>
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://i.pravatar.cc/150?img=2" alt="Calvin Steward profile picture"/>
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://i.pravatar.cc/150?img=3" alt="Ralph Richards profile picture"/>
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://i.pravatar.cc/150?img=4" alt="Bernard Murphy profile picture" />
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://i.pravatar.cc/150?img=5" alt="Arlene Robertson profile picture"/>
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://i.pravatar.cc/150?img=6" alt="Jane Lane profile picture"/>
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://i.pravatar.cc/150?img=7" alt="Pat Mckinney profile picture" />
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://i.pravatar.cc/150?img=8" alt="Norman Walters profile picture"/>
                      </div>
